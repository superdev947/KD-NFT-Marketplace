...
const nft = () => {
  ...
  const listSale = async () => {
    ...
    if (price % 1 == 0) {
      ...
      setStatus({
        message: "Price can be in only whole numbers.",
        type: "error",
      });
      setIsLoading(false);
    }
  ...
  const fetchMetadata = async () => {
    ...
    setImageUrl(
      `https://purple-given-reindeer-860.mypinata.cloud/ipfs/${
        img.split("ipfs://")[1]
      }`
    );
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <span className="text-sm">
                owned by {`${tokenOwner}`.slice(0, 5) + ".."}
              </span>

              <p className="text-lg mt-4 text-black">
                There are 10,000 Kongs running rampant on the KardiaChain
                Network!
              </p>
